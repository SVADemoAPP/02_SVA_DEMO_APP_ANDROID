...
public class PrruShape extends Shape
{
    ...
    public void draw(Canvas canvas)
    {
        ...
        ImageView imageView = (ImageView) view.findViewById(R.id.iv_prru);
        ImageView imageView1 = (ImageView) view1.findViewById(R.id.iv_prru);
        ImageView imageView2 = (ImageView) view2.findViewById(R.id.iv_prru);
